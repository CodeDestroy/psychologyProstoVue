      ...
      <div class="relative mx-auto max-w-2xl py-24 sm:py-16 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div class="col-span-2 w-64 lg:col-end-1 lg:row-span-2 lg:w-72">
            <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="/img/about_kochetkova.jpg" alt="" />
          </div>
          <figcaption class="text-base lg:col-start-1 lg:row-start-1">
            <div class="text-lg font-semibold text-purple-800 sm:text-2xl">Светлана Васильевна Кочеткова</div>
            <div class="mt-1 text-gray-500">аналитический психолог, супервизор</div>
          </figcaption>
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <ul class="marker:text-purple-800 list-disc ps-4">
                <li>кандидат РОАП/IAAP</li>
                <li>руководитель института Практической Психологии и Постдипломного Образования "Персона"</li>
                <li>организатор обучающей программы "Основы аналитического консультирования и психотерапии"</li>
                <li>председатель Воронежского Сообщества Аналитической Психологии (ВСАП)</li>
              </ul>
            </blockquote>
          </div>
        </figure>
