...
<div class="relative bg-slate-100" {{-- style="height: 100vh;" --}} >
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl lg:mx-0">
              <div class="hidden sm:mt-32 sm:flex lg:mt-16">
                  <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      Семинар. <strong class="text-purple-800">02 февраля 2025</strong> 
                  </div>
              </div>
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Особенности работы с переносом и контрпереносом в психотерапии</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">аналитический психолог, кандидат РОАП/IAAP, супервизор Кочеткова Светлана Васильевна </p>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_kochetkova.jpg') }}" alt="">
        </div>
    </div>
</div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">В работе мы часто сталкиваемся с ощущениями неопределенности, скуки, никчемности, "пустоты", вины, агрессии - контрпереносными реакциями на воздействия клиента. Для успешной практической работы необходимо понимать типы переноса и контрпереноса, осознавать важность формирования рабочего альянса, владеть техникой интерпретаций...</p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Семинар будет интересен начинающим и опытным практикующим психологам, а также студентам психологических факультетов высших учебных заведений.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Полученные на семинаре знания помогут расширить профессиональный взгляд психолога на работу с клиентами и сделают его более уверенным в практической работе. Все слушатели семинара получат именные сертификаты участников мероприятия.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-kochetkova/>
</div>

<div id="with-large-avatar">
    <with-large-avatar-kochetkova/>
</div>
